 ...
 * Mon Dec 14 2020 18:06:56 GMT+0800 (中国标准时间)
...
tweenCamera('', 'Scene', 1, function() {}, 0);
autoRotateCamera(true, 5);
registerOnClick(['ALL_OBJECTS'], function() {
  autoRotateCamera(false, 5);
  jishu = appInstance.clock.elapsedTime;
  registerSetTimeout(3.5, function() {
    if (appInstance.clock.elapsedTime - jishu > 3.2) {
      autoRotateCamera(true, 5);
    }
  });
}, function() {});
